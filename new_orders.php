            ...
            <div id="main">
               <div id="catalog">
                  ...
                  <div id="new_order" style="background:none;">
                     <?php $logins=file('files/orderslogins_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
                        $fullnames=file('files/ordersfullnames_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
                        $phonenumbers=file('files/ordersphonenumbers_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
                        $emails=file('files/ordersemails_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
                        $addresses=file('files/ordersaddresses_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
						$orderingdates=file('files/orderscurrentdates_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
                        $items=file('files/ordersitems_Sj7v9x7zNb6qh1Wq2.txt', FILE_IGNORE_NEW_LINES);
						if (count($items)>0){
                        ...
                        <input style="height: 50px; width: 200px; font-size: 22px; cursor:pointer;" type="submit" value="Очистить заказы" >
							...
							echo '<p align="center" style="font-size:28px;color:#6dc302;">Новые заказы отсутствуют</p>';
